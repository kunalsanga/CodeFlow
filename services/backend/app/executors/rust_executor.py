...
logger = logging.getLogger("codeflow.executors.rust")

class RustExecutor(ILanguageExecutor):
    """
    Rust Language Trace Executor for CodeFlow.
    Parses Rust cargo compilation and trace steps into unified IExecutionTrace schema.
    """
    ...
    def execute(self, code: str, timeout_seconds: float = 10.0) -> Dict[str, Any]:
        if not code or not code.strip():
            return {
                ...
                "trace": [],
                "stdout": "",
                "error": "Rust code string cannot be empty",
                "language": "rust"
            }
